(function ($) {
  ...
  $("#install-activate-button").on("click", function (e) {
    ...
    var activationData = {
      action: "lavisto_install_and_activate_plugins",
      nonce: lavisto_localize.nonce,
    };
    $.post(lavisto_localize.ajax_url, activationData, function (response) {
      ...
      if (match) {
        ...
        try {
          ...
          if (responseObj.success === true) {
            window.location.href = lavisto_localize.redirect_url;
          } else {
            console.log("Error!");
          }
        } catch (error) {
