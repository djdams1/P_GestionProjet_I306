 ...
 * Slug: lavisto/footer-with-ctabutton
...
<div class="wp-block-group has-light-shade-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"style":{"spacing":{"padding":{"top":"40px","right":"0","left":"0","bottom":"30px"},"margin":{"top":"0","bottom":"0"}},"border":{"width":"0px","style":"none"}},"backgroundColor":"light-shade","className":"lavisto-footer","layout":{"type":"constrained","contentSize":"100%"}} -->
    <div class="wp-block-group lavisto-footer has-light-shade-background-color has-background" style="border-style:none;border-width:0px;margin-top:0;margin-bottom:0;padding-top:40px;padding-right:0;padding-bottom:30px;padding-left:0"><!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|40","left":"var:preset|spacing|40"}}},"layout":{"type":"constrained","contentSize":"1200px"}} -->
        <div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)"><!-- wp:columns {"style":{"spacing":{"blockGap":{"left":"50px"},"margin":{"top":"0px"},"padding":{"bottom":"40px"}},"border":{"bottom":{"color":"#d6dbe7","width":"1px"},"top":[],"right":[],"left":[]}}} -->
            <div class="wp-block-columns" style="border-bottom-color:#d6dbe7;border-bottom-width:1px;margin-top:0px;padding-bottom:40px"><!-- wp:column {"width":"45%","className":"lavisto-footer-list"} -->
                <div class="wp-block-column lavisto-footer-list" style="flex-basis:45%"><!-- wp:social-links {"iconColor":"light-color","iconColorValue":"#FFFFFF","iconBackgroundColor":"dark-shade","iconBackgroundColorValue":"#0039CA","style":{"spacing":{"blockGap":{"top":"0","left":"var:preset|spacing|30"},"margin":{"top":"30px","bottom":"0"}}}} -->
            ...
            <div class="wp-block-columns" style="margin-top:40px"><!-- wp:column {"className":"lavisto-footer-list"} -->
                <div class="wp-block-column lavisto-footer-list"><!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"400","textTransform":"uppercase"},"elements":{"link":{"color":{"text":"var:preset|color|heading-color"}}}},"textColor":"heading-color","fontSize":"medium"} -->
                    <h3 class="wp-block-heading has-heading-color-color has-text-color has-link-color has-medium-font-size" style="font-style:normal;font-weight:400;text-transform:uppercase"><?php esc_html_e('Our Brands', 'lavisto') ?></h3>
                    <!-- /wp:heading -->
            ...
            <!-- wp:group {"style":{"spacing":{"margin":{"top":"60px"},"padding":{"top":"40px","bottom":"10px"},"blockGap":"var:preset|spacing|50"},"border":{"top":{"color":"#d6dbe7","width":"1px"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
            <div class="wp-block-group" style="border-top-color:#d6dbe7;border-top-width:1px;margin-top:60px;padding-top:40px;padding-bottom:10px"><!-- wp:image {"id":1129,"width":"240px","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|primary-duo"}}} -->
